  ...
  return (
    <div className="flex flex-col items-center">
      <div className="flex flex-col gap-4 border border-solid border-gray-200 shadow-sm rounded-lg p-3 mb-4">
        <div className="text-black font-bold mb-2 flex justify-center">
          Advanced
        </div>
        <div className="text-gray-400 flex flex-col gap-1">
          ...
          />
          <div className="pl-4">
            Choose if subscriptions will be billed at 1st day of new month or
            new week
          </div>
        </div>
        <div className="flex flex-col mt-3 gap-2">
          ...
          <div className="text-gray-400 ml-3">
            This option is to limit maximum amount of subscribers for the
            selected tier
          </div>
        </div>
        <div className="flex flex-col mt-3 gap-1">
          ...
          <div className="text-gray-400 ml-3">
            ...
            their shipping addresses at the checkpoint
          </div>
        </div>
        <div>
      ...
      <Button label="Save changes" textColor="bg-gray-200 text-gray-400" />
    </div>
  );
}
